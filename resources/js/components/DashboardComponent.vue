    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-12 mr-0 pr-0">
        <section class="bg-white p-4">
          <h5 class="font-weight-bolder">New Company Event</h5>
          <new-event-component/>
        </section>
      </div>
...
<script>
    ...
    components: {
      NewChecklistItem,
      ChecklistComponent,
      CreditsChartComponent,
      LastYearYouCanClaimPayrollComponent,
      NextEligibleQuarterComponent, RecentEventsComponent, NewEventComponent}
  }
</script>
